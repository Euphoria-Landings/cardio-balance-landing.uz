...
export default function Purchase() {
  const cards = [
    {
      title: "yurak va qon tomirlari",
      desc: "Yurak mushaklarini mustahkamlaydi, qon tomirlar devorlarini elastik qiladi va qon aylanishini yaxshilaydi.",
      icon: (
        <svg
          viewBox="0 0 24 24"
          fill="none"
    ...
    {
      title: "ortiqcha zo‘riqish, stress",
      desc: "2–4 hafta ichida ko'pchilik ish bosimi, dedlaynlarni yengilroq ko'taradi, yurak urishi barqarorlashadi va ko'krakdagi bezovtalik kamayadi.",
      icon: (
        <svg
          viewBox="0 0 24 24"
          fill="none"
    ...
    },
    {
      ...
      desc: "Tarkibi 100% sintetik kimyoviy moddalarsiz, balki o'simlik ekstraktlari, vitaminlar, minerallar va tabiiy antioksidantlardan iborat",
      icon: (
        <svg
          viewBox="0 0 24 24"
          fill="none"
